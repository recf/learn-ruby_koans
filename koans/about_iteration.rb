...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # reduce a collection down to a single value by applying a function to an
    # accumulator value and the current item in the list. The initial
    # accumulator value must be specified.
  end
  ...
  # We need to close the file handle. do-end handles that for us.
