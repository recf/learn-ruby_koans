...
class AboutSymbols < Neo::Koan
  ...
  # Using the symbol creates it, therefore adding it to the list of 
  # defined symbols, which would make an #include? call always return true
  ...
  # Symbols never get garbage collected, so they stay in memory until 
  # the program exits.
end
