...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When that character is not represented in the haystack at all.
    assert_equal nil, "abbcccddddeeeee"[/yz*/]
  end
  ...
  # They grab as many matching characters as possible, but also as soon as
  # possible.
  ...
  # Character class is more general, in that it will match any string made up of
  # a set of characters. Alternatation is for when the search space is reduced,
  # especially when the letters have to appear in a specific order.
